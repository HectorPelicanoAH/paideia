...
const es: InteriorLanguageContent = {
  ...
  pages: {
    ...
    origen: {
      title: 'De dónde nace PAIDEIA', intro: 'Una inquietud personal convertida en una propuesta pública que necesita ser cuestionada, mejorada y compartida.', description: 'El origen de PAIDEIA y el papel inicial de Héctor en una iniciativa todavía fundacional.',
      sections: [
        { id: 'origen', title: 'Una pregunta abierta', paragraphs: ['Soy Héctor y vivo en L’Argentera, un pequeño pueblo de Tarragona. Trabajo en el mundo de la tecnología, pero desde hace tiempo me acompaña una inquietud: hemos desarrollado una enorme capacidad técnica mientras nos alejábamos de muchos de los conocimientos, relaciones y procesos que sostienen nuestra vida.', 'PAIDEIA nace de esa inquietud y de una pregunta: ¿qué ocurriría si volviéramos a crear lugares donde aprender haciendo, sentirnos útiles, cuidar un territorio y transmitir aquello que sabemos?', 'He dado forma y hecho pública esta primera propuesta, pero no quiero construirla solo ni presentarla como una idea terminada. Tampoco pretendo ocupar un lugar de experto en ámbitos que requieren conocimientos y experiencias que yo no tengo.', 'Mi papel inicial es impulsar la conversación, reunir a personas diferentes y ayudar a convertir una intuición en una propuesta que pueda contrastarse con la realidad.', 'No busco seguidores para una idea terminada. Busco personas con las que construirla.'] },
        ...
        { id: 'papel', title: 'Mi papel inicial', paragraphs: ['Impulsar, conectar y organizar; formular con claridad la propuesta; y compartir progresivamente la responsabilidad con un núcleo fundador. PAIDEIA no debería depender de una sola persona.'] },
